...
catches, so that enthuisasits can create a community and
...
will enable prticipants to Create, Read, Update and Delete (CRUD),
their Magnet Fishing catcches.
...
more comfortable enviironmet after a long day Magnet Fishing.
...
- "It would be great to connect with others. To meet up and Magnet Fish together and share finds!"
...
The naviagtion bar will include the links `Home`, `Catch Log`, 
...
Each particpatnts log can be deleted/edited as they wish.
...
other's to view. A Map will be provided to help define the area of
Stockholm particpants have been Magnet Fishing in. 
...
main colors centered around red, `rgb(254, 17, 71)`, and blue,
`rgb(26, 16, 112)`.

The text will be white,`rgb(255,255,255)`, and placed against a
background color of blue, `rgb(26, 16, 112)` for clarity of read.
...
All fonts are obtained from `Google Fonts`.
...
A Logo will be displayed promontely at top and center of each
Webpage and be a clickable link that will direct you to back
to `Home`. This logo helps define the Website and will be the
first observation for users entering site, promoting and
instilling this new sport.

The Navbar and content of each Webpage will be displayed in
an inner `container`, over an outer `container`, allowing content
to flow against a fixed background image when scrollng. 
...
- **Desktop:** The navigation bar will be centered and placed
under the 'Magnet Fishing Stockholm' logo. It will hav a left
...
The font color used for the links will be white,
...
`rgb(190, 190, 190, 1)`. A sutuable offset color that does
